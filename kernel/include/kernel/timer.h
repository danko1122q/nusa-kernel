...
// This file defines the timer API for the NUSA kernel.
...
struct timer;
typedef enum handler_return (*timer_callback)(struct timer *, nusa_time_t now, void *arg);
...
typedef struct timer {
    ...
    nusa_time_t scheduled_time;
    nusa_time_t periodic_time;
...
void timer_set_oneshot(timer_t *, nusa_time_t delay, timer_callback, void *arg);

// Sets a timer to fire periodically at the specified interval.
void timer_set_periodic(timer_t *, nusa_time_t period, timer_callback, void *arg);
