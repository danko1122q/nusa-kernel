//! Application support
//!
//! Applications in NUSA are managed through a descriptor, the combines a name,
...
//! Applications for Rust consist of someting that implements the `NusaApp` trait.
//! The `init` function from nusa is used to invoke the constructor for this
...
//! call from nusa on `main` will only invoke the `main` method after previous
...
/// Something that implements an NUSA application.  The 'new' method is invoked
...
pub trait NusaApp: Sized + Send + 'static {
