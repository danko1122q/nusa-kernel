//! Build support for Rust on NUSA
//
...
fn main() -> anyhow::Result<()> {
    ...
    let bindings = bindings
        ...
        .newtype_enum("nusa_init_level")
        .newtype_enum("nusa_init_flags")
        ...
        .allowlist_type("nusa_init_level")
        .allowlist_type("nusa_init_flags")
        .allowlist_type("nusa_init_struct")
