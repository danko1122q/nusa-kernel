...
/* platform_halt is a method which is called from various places in the NUSA
 ...
 * of a failed ASSERT or a panic, NUSA will call platform halt and suggest a Halt
...
/* Called by NUSA to get the device tree */
