...
.PHONY: help
help:
	@echo "NUSA build system quick help"
	@echo "Individual projects are built into a build-<project> directory"
	@echo "Output binary is located at build-<project>/nusa.bin"
	@echo ""
...
PROJECTS:=$(basename $(strip $(foreach d,$(NUSAINC),$(wildcard $(d)/project/*.mk))))
