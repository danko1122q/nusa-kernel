...
ssize_t arm_dcc_read(uint32_t *buf, size_t len, nusa_time_t timeout) {
    nusa_time_t start = 0;
...
ssize_t arm_dcc_write(const uint32_t *buf, size_t len, nusa_time_t timeout) {
    nusa_time_t start = 0;
