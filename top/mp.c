...
void nusa_secondary_cpu_entry_early(void) {
    ...
    nusa_init_level(LK_INIT_FLAG_SECONDARY_CPUS, LK_INIT_LEVEL_EARLIEST, LK_INIT_LEVEL_THREADING - 1);
}

void nusa_secondary_cpu_entry(void) {
...
static int secondary_cpu_bootstrap_thread(void *arg) {
    ...
    nusa_init_level(LK_INIT_FLAG_SECONDARY_CPUS, LK_INIT_LEVEL_THREADING, LK_INIT_LEVEL_LAST);
