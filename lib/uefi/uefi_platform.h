...
// uefi_malloc is used by NUSA to allocate memory that would be used by UEFI
// applications
...
// Called by NUSA once before executing UEFI application to setup the heap
void setup_heap();
// Caled by NUSA once after executing UEFI application to tear down the heap
void reset_heap();
