...
static paddr_t find_rsdp_pc() {
  ...
  auto ac = nusa::make_auto_call([bios_ptr]() {
...
static void* get_immed_rsdp() {
  ...
  if (_multiboot_info != 0) {
    ...
    if (hdr_map) {
      auto cleanup_hdr = nusa::make_auto_call([hdr_map]() {
      ...
      if (total_size >= sizeof(*multiboot_hdr) && total_size <= 1024 * 1024) {
        ...
        if (rsdp_map) {
          auto cleanup_rsdp_map = nusa::make_auto_call([rsdp_map]() {
...
static status_t initialize_table(size_t i) {
  ...
  auto cleanup_header_mapping = nusa::make_auto_call([header]() {
...
status_t acpi_lite_init(paddr_t rsdp_pa) {
  ...
  auto cleanup_rsdp_mapping = nusa::make_auto_call([rsdp_ptr]() {
  ...
  auto cleanup_sdt_mapping = nusa::make_auto_call([sdt_ptr]() {
