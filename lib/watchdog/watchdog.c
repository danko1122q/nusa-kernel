...
static enum handler_return watchdog_timer_callback(struct timer *timer, nusa_time_t now, void *arg) {
...
static nusa_time_t hw_watchdog_pet_timeout;

static enum handler_return hw_watchdog_timer_callback(struct timer *timer, nusa_time_t now, void *arg) {
